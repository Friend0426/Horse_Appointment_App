    ...
    return Row(
      ...
      children: [
        ...
        Container(
          ...
          child: Center(child: MyText(txt: w1.toString(), color: week_showing==w1?Colors.white: Colors.black, txtSize: 20,fontWeight: FontWeight.bold)),
        ...
        Container(
          ...
          child: Center(child: MyText(txt: w2.toString(), color:week_showing==w2?Colors.white: Colors.black, txtSize: 20,fontWeight: FontWeight.bold)),
        ...
        Container(
          ...
          child: Center(child: MyText(txt: w3.toString(), color:week_showing==w3?Colors.white: Colors.black, txtSize: 20,fontWeight: FontWeight.bold)),
