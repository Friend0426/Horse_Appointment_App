      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 5,),
            My_Btn(txt: 'Call', btn_color: Colors.green, btn_size: 200, gestureDetector: GestureDetector(onTap: () {

            },)),
            SizedBox(height: 5,),
            My_Btn(txt: 'Message', btn_color: Colors.green, btn_size: 200, gestureDetector: GestureDetector(onTap: () {
